...
export class AddProductComponent {
  ...
  constructor() {
    this.addProductForm = new FormGroup({
      productName: new FormControl('', [Validators.required]),
      productDescription: new FormControl(''),  // Product description field
      basePrice: new FormControl('', [Validators.required]),
      discountPercentage: new FormControl('', [Validators.required]),
      vatPrice: new FormControl('', [Validators.required]),
      sku: new FormControl('', [Validators.required]),
  ...
  onSubmit() {
    if (this.addProductForm.valid) {
      ...
      console.log('Products array updated and stored in local storage:', this.products);

      // Clear the form to allow adding another product
